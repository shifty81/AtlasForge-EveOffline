// EVEOFFLINE Project Validation Tests
// Validates that the eveoffline project structure is complete and correct.
// Run via: atlas_runtime --project projects/eveoffline/eveoffline.atlas --validate-only
...
void test_manifest_exists() {
    assert(FileExists("eveoffline.atlas"));
    assert(FileContains("eveoffline.atlas", "atlas.project.v1"));
    assert(FileContains("eveoffline.atlas", "EVEOFFLINE"));
    std::cout << "[PASS] test_manifest_exists" << std::endl;
}

void test_plugin_toml_exists() {
    assert(FileExists("Plugin.toml"));
    assert(FileContains("Plugin.toml", "id = \"eveoffline\""));
...
void test_schemas_exist() {
    assert(FileExists("Schemas/eveoffline.ship.v1.json"));
    assert(FileExists("Schemas/eveoffline.module.v1.json"));
    assert(FileExists("Schemas/eveoffline.npc.v1.json"));
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "EVEOFFLINE Project Validation Tests" << std::endl;
